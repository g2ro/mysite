...
$(function(){
		...
		$.ajax({
			url: "${pageContext.request.contextPath }/api222/user/checkemail?email=" + email,
			type: "get",
			dataType: "json",
			...
			<div id="user">
				...
				<form:form
					...
					<fieldset>
						...
						<label><spring:message code="user.join.label.gender.female"/></label> <form:radiobutton path="gender" id="female" value="female" checked="checked"/> 
						<label><spring:message code="user.join.label.gender.male"/></label> <form:radiobutton path="gender" id="male" value="male"/>
					</fieldset>
